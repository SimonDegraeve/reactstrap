...
var propTypes = {
  ...
  expandable: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.string])
};
...
var Navbar = function Navbar(props) {
  ...
  var toggleable = props.toggleable,
      ...
      color = props.color,
      Tag = props.tag,
      attributes = _objectWithoutProperties(props, ['toggleable', 'expandable', 'className', 'cssModule', 'light', 'dark', 'inverse', 'fixed', 'sticky', 'color', 'tag']);

  var classes = (0, _utils.mapToCssModules)((0, _classnames2.default)(className, 'navbar', getToggleableClass(toggleable || expandable), (_classNames = {
    'navbar-light': light,
